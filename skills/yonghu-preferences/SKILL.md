...
```text
Stable user preference -> yonghu-preferences
Project-specific rule -> AGENTS.md / .ai_project.md / docs/
Skill-pack rule -> MANIFEST.md + yonghu-preferences if user-level
...
```markdown
用户画像：
- 更新 `yonghu-preferences/references/profile.md`
```
...
```markdown
女助理：
- 更新 `yonghu-preferences/user-skills/<skill-name>.md`
```
