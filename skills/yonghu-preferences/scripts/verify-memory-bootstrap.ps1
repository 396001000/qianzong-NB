...
$BasePath = Join-Path $CodexHome 'skills\yonghu-preferences'
$KnownWindowsPath = Join-Path $HOME '.codex\skills\yonghu-preferences'
...
function New-IndexContent {
  ...
  $lines.Add('')
  $lines.Add('User skills are global user memory and routing context. They live under `$CODEX_HOME/skills/yonghu-preferences/user-skills/`, not inside an individual project.')
  $lines.Add('')
