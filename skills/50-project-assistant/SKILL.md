...
Use with `documentation-and-adrs` for project rules and decisions, `docs-index-maintainer` for index updates, `project-sync-audit` for drift checks, and `yonghu-preferences` for cross-project user preferences.
...
| Cross-project user preference | `yonghu-preferences/references/profile.md` |
...
- Cross-project user preferences. Put those in `yonghu-preferences`.
