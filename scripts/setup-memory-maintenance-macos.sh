...
MAINTAIN_SCRIPT="$CODEX_HOME_DIR/skills/yonghu-preferences/scripts/maintain-memory.mjs"
LAUNCH_AGENTS="$HOME/Library/LaunchAgents"
DAILY_LABEL="com.qianzong-nb.memory.daily"
WEEKLY_LABEL="com.qianzong-nb.memory.weekly"
