...
$MaintainScript = Join-Path $CodexHome 'skills\yonghu-preferences\scripts\maintain-memory.mjs'
$DailyName = 'qianzong-NB Memory Daily'
$WeeklyName = 'qianzong-NB Memory Weekly'
