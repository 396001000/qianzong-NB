...
- Keep `skills/yonghu-preferences/` aligned with the separately installed `AGENTS5.3.md` prompt behavior.
...
- Runtime prompt and user-skills can drift if qianzong-NB is not resynced after global updates or if `AGENTS5.3.md` is not manually installed on another computer.
...
- This repository distributes skills only; adding global `AGENTS.md`, project-level `AGENTS.md`, `AGENTS5.3.md`, or owner-specific prompt content would violate the current distribution boundary.
